...
const Home = () => {
  return (
    <div
      ...
      style={{ height: "100vh" }}
    >
      <div className="my-auto md:px-12 sm:py-12 py-8 rounded-3xl w-full max-w-7xl mx-auto flex md:flex-row flex-col gap-y-8 z-20 bg-gray-50 bg-opacity-60 shadow-xl gap-x-4 px-4 animate-fade-up animate-duration-500 animate-delay-500">
        <div className="md:w-1/2 w-full h-full text-center flex flex-col sm:gap-y-8 gap-y-4 text-secondary-gray my-auto justify-center">
          <h1 className="sm:text-4xl text-2xl animate-fade-up animate-duration-[1s] animate-delay-1000">
            Welcome to
            <span className="text-primary-blue font-bold ml-2">
              Product Finder
            </span>
          </h1>
          <p className="sm:text-lg text-left animate-fade-up animate-duration-[1s] animate-delay-[1.2s] mt-2">
